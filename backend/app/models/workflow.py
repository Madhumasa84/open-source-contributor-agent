...
from sqlalchemy import JSON, UUID, DateTime, ForeignKey, String, Text
...
class WorkflowRun(Base):
    ...
    plan_approval_status: Mapped[str] = mapped_column(String(20), default="pending")
    final_approval_status: Mapped[str] = mapped_column(String(20), default="pending")
    repository: Mapped[dict] = mapped_column(JSON, default=dict)
    triage_data: Mapped[dict] = mapped_column(JSON, default=dict)
    ...
    patch_iterations: Mapped[int | None] = mapped_column(nullable=True)
    patch_test_status: Mapped[str | None] = mapped_column(String(40), nullable=True)
    triage_data: Mapped[dict] = mapped_column(JSON, default=dict)
