...
class DuplicateIssueDetector:
    ...
    async def detect_duplicates(self, new_issue_summary: str, current_issue_url: str, workflow_id: str) -> list[dict]:
        """
        ...
        async with AsyncSessionLocal() as session:
            ...
            try:
                result = await session.execute(
                    text("SELECT url, summary, embedding FROM issue_embeddings WHERE url != :current_url"),
